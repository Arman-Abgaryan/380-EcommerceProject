...
public class Test {
    public static void main(String[] args) {
        ...
        Customer Alfredo = new Customer("Alfredo", "Ulloa", "alfredoulloa@ymail.com", "Not Found");
        Customer person1 = new Customer("John", "Doe", "johndoe@gmail.com", "123 Elm St");
        Customer p3 = new Customer("Albert", "Smith", "albert.smith@mail.com.com", "694 Daisy Ln");
        ...
        try {
            ...
            shop.addItem(shirt,3);
            coolItems.addItem(shirt, 2);
            bad.addItem(shirt,5);
